...
import { ArrowUpRight, Calendar, Loader2, Search } from 'lucide-react';
    ...
    <div className="mx-auto max-w-7xl space-y-6 pb-12">
      <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
        <div className="bg-[linear-gradient(130deg,#fffdfb_0%,#edf6ff_52%,#dff7f6_100%)] px-6 py-8 text-slate-900 md:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">Read published articles shared through the portfolio.</p>
        </div>
