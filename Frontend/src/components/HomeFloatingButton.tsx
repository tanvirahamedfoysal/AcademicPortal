          ...
          <div className="relative group">
            ...
            <Link href="/" aria-label="Return to Homepage">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="relative flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-tr from-[#78bac5] to-[#78bac5] text-white shadow-lg shadow-[#78bac5]/30 hover:shadow-[#78bac5]/35 transition-shadow"
              >
                ...
                <span className="absolute inset-0 rounded-full border-2 border-[#78bac5] opacity-50 animate-[ping_2.5s_cubic-bezier(0,0,0.2,1)_infinite_0.5s]" />
