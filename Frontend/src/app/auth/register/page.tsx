      ...
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-[1420px] overflow-hidden rounded-[28px] border border-[#d9e6ee] bg-[#fffdfb] shadow-[0_24px_70px_rgba(73,101,126,.12)] lg:grid-cols-[.78fr_1.22fr]">
        <section className="relative hidden overflow-hidden bg-[linear-gradient(145deg,#edf6ff_0%,#dff7f6_48%,#f8dce7_100%)] p-12 text-slate-900 lg:flex lg:flex-col lg:justify-between xl:p-16">
          ...
          <div className="relative max-w-lg">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#d98bab]">Academic community</p>
            ...
            <div className="mt-9 flex items-center gap-4 rounded-2xl border border-[#d6e5ec] bg-[#fffdfb]/70 p-5"><UsersRound className="h-6 w-6 text-[#d98bab]" /><div><p className="font-serif text-lg font-bold">Research community access</p><p className="mt-1 text-xs text-slate-500">Articles · resources · collaborators · profile</p></div></div>
          </div>
