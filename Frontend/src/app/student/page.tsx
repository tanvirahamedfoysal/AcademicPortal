...
export default function StudentDashboardHome() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 pb-12">
      <section className="relative overflow-hidden rounded-[2rem] bg-[linear-gradient(130deg,#fffdfb_0%,#f8dce7_52%,#dff7f6_100%)] p-7 text-slate-900 shadow-sm md:p-9"><div className="absolute -right-14 -top-14 h-56 w-56 rounded-full border border-white/10" /><div className="relative max-w-3xl"><div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700"><Sparkles className="h-3.5 w-3.5" /> Learning workspace</div><h1 className="font-serif text-3xl font-semibold md:text-4xl">Research Learning Hub</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">Move from reading to participation: discover published work, use shared resources, find peers, and stay connected to the research community.</p></div></section>
